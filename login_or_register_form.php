		...
		<div class="row">
			<div class="col-md-6">
				...
				<form action="login.php" method="POST">
					...
					<hr />
					<input type="submit" value = "&nbsp;Log Me In&nbsp;" class="btn btn-info" <span class="glyphicon glyphicon-user"></span>
				</form>
			</div>
            <div class="col-md-6">
                <h4> Or Register </h4>
                ...
                <form action="register.php" method="POST">
                    ...
                    <input type="password" name="confirmation" value="" placeholder="repeat password" class="form-control" />
                    <hr />
                    <input type="submit" value = "&nbsp;Register me&nbsp;" class="btn btn-info" <span class="glyphicon glyphicon-user"></span>
                </form>
            </div>
